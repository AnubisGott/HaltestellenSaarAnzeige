...
public class TestParsing2 {
    ...
    public void test_06_CheckDepartureTime_Row1() {
        ...
        assertTrue("17:04".contentEquals(parser.getDepartureRow(0)));
    }
    ...
    public void test_07_CheckDepartureTime_Row2() {
        ...
        assertTrue("17:20".contentEquals(parser.getDepartureRow(1)));
    }
    ...
    public void test_08_CheckDepartureTime_Row3() {
        ...
        assertTrue("17:34".contentEquals(parser.getDepartureRow(2)));
    }
    ...
    public void test_09_CheckDepartureTime_Row4() {
        ...
        assertTrue("17:50".contentEquals(parser.getDepartureRow(3)));
    }
    ...
    public void test_10_CheckDepartureTime_Row5() {
        ...
        assertTrue("18:04".contentEquals(parser.getDepartureRow(4)));
    }
    ...
    public void test_11_CheckPredictTime_Row1() {
        ...
        assertTrue("+2 min.".contentEquals(parser.getPredictionRow(0)));
    }
    ...
    public void test_13_CheckPredictTime_Row3() {
        ...
        assertTrue("+1 min.".contentEquals(parser.getPredictionRow(2)));
    }
    ...
    public void test_21_CheckDestination_Row0() {
        ...
        assertTrue("Lebach".contentEquals(parser.getDestinationRow(0)));
    }
    ...
    public void test_23_CheckDestination_Row2() {
        ...
        assertTrue("Lebach".contentEquals(parser.getDestinationRow(2)));
    }
    ...
    static final String FILE_CONTNENT = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\" \"http://www.w3.org/TR/html4/loose.dtd\">\n" +
            ...
            "<td class=\"pagetitle right\">Aktueller Abfahrtsplan g&#252;ltig am 15.10.17 (17:06 - 18:04 Uhr)</td>\n" +
            "</tr>\n" +
            "</table>\n" +
            ...
            "<tr>\n" +
            "<td class=\"nowrap links\"><a href=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=17:06&maxJourneys=5&dateBegin=&dateEnd=&selectDate=today&productsFilter=7:1111101&editStation=yes&dirInput=&\"><img class=\"icon\" src=\"/hafas-res/img/icon_std.gif\" width=\"13\" height=\"13\" alt=\"\" /> Anfrage &#228;ndern</a><a href=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&\"><img class=\"icon\" src=\"/hafas-res/img/icon_std.gif\" width=\"13\" height=\"13\" alt=\"\" /> Neue Anfrage</a><a href=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=arr&time=17:06&maxJourneys=5&dateBegin=&dateEnd=&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\"><img class=\"icon\" src=\"/hafas-res/img/icon_std.gif\" width=\"13\" height=\"13\" alt=\"\" /> Ankunftsplan</a><a href=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=17:06&maxJourneys=5&dateBegin=&dateEnd=&selectDate=today&productsFilter=7:1111101&start=yes&pageViewMode=PRINT&dirInput=&\" target=\"Printview\" onclick=\"openPopup('about:blank','Printview',20,200,700,600,'001000');\" accesskey=\"p\"><img class=\"icon\" src=\"/hafas-res/img/icon_print.gif\" width=\"14\" height=\"14\" alt=\"\" /> Druckansicht</a></td></tr>\n" +
            "</table>\n" +
            "<div class=\"separator\" style=\"margin-bottom:1px;\"><img src=\"/hafas-res/img/stress_sep.gif\" width=\"11\" height=\"11\" alt=\"\" />Abfahrt (17:06 - 18:04)</div>\n" +
            ...
            "<td class=\"bold center sepline top\">17:04</td>\n" +
            "<td class=\"sepline nowrap top\">\n" +
            "<span class=\"rtDelayed\">+2 min.</span>\n" +
            "</td>\n" +
            "<td class=\"bold top nowrap sepline\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/traininfo.exe/dn/31437/35275/288820/133941/80?L=public&backLink=sq&date=15.10.17&time=17:04&sqPf=7:1111101&sqMj=5&sqDa=15.10.17&sqTi=17:06&station_evaId=15537&sqType=dep&station_type=dep&sqEvaId=15537&\"><img src=\"/hafas-res/img/sbs_pic.gif\" width=\"24\" height=\"24\" alt=\"S      1\" style=\"vertical-align:top\"> S      1</a>\n" +
            "</td>\n" +
            ...
            "<td class=\"bold center sepline top\">17:20</td>\n" +
            "<td class=\"sepline nowrap top\">\n" +
            "<span class=\"rtOnTime\" title=\"+0 min.\">p&#252;nktl.</span>\n" +
            "</td>\n" +
            "<td class=\"bold top nowrap sepline\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/traininfo.exe/dn/366984/147175/270802/13073/80?L=public&backLink=sq&date=15.10.17&time=17:20&sqPf=7:1111101&sqMj=5&sqDa=15.10.17&sqTi=17:06&station_evaId=15537&sqType=dep&station_type=dep&sqEvaId=15537&\"><img src=\"/hafas-res/img/sbs_pic.gif\" width=\"24\" height=\"24\" alt=\"S      1\" style=\"vertical-align:top\"> S      1</a>\n" +
            "</td>\n" +
            "<td class=\"sepline top\">\n" +
            "<span class=\"bold\">\n" +
            ...
            "</tr>\n" +
            "<tr class=\"depboard-dark\">\n" +
            "<td class=\"bold center sepline top\">17:34</td>\n" +
            "<td class=\"sepline nowrap top\">\n" +
            "<span class=\"rtDelayed\">+1 min.</span>\n" +
            "</td>\n" +
            "<td class=\"bold top nowrap sepline\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/traininfo.exe/dn/795345/289885/867076/168423/80?L=public&backLink=sq&date=15.10.17&time=17:34&sqPf=7:1111101&sqMj=5&sqDa=15.10.17&sqTi=17:06&station_evaId=15537&sqType=dep&station_type=dep&sqEvaId=15537&\"><img src=\"/hafas-res/img/sbs_pic.gif\" width=\"24\" height=\"24\" alt=\"S      1\" style=\"vertical-align:top\"> S      1</a>\n" +
            "</td>\n" +
            "<td class=\"sepline top\">\n" +
            "<span class=\"bold\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=8000563&boardType=dep&time=now&selectDate=today&maxJourneys=5&productsFilter=7:1111101&start=yes\">\n" +
            ...
            "</tr>\n" +
            "<tr class=\"depboard-light\">\n" +
            "<td class=\"bold center sepline top\">17:50</td>\n" +
            "<td class=\"sepline nowrap top\">\n" +
            "<span class=\"rtOnTime\" title=\"+0 min.\">p&#252;nktl.</span>\n" +
            "</td>\n" +
            "<td class=\"bold top nowrap sepline\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/traininfo.exe/dn/85515/53352/463446/203219/80?L=public&backLink=sq&date=15.10.17&time=17:50&sqPf=7:1111101&sqMj=5&sqDa=15.10.17&sqTi=17:06&station_evaId=15537&sqType=dep&station_type=dep&sqEvaId=15537&\"><img src=\"/hafas-res/img/sbs_pic.gif\" width=\"24\" height=\"24\" alt=\"S      1\" style=\"vertical-align:top\"> S      1</a>\n" +
            "</td>\n" +
            "<td class=\"sepline top\">\n" +
            "<span class=\"bold\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=8001135&boardType=dep&time=now&selectDate=today&maxJourneys=5&productsFilter=7:1111101&start=yes\">\n" +
            ...
            "</tr>\n" +
            "<tr class=\"depboard-dark\">\n" +
            "<td class=\"bold center sepline top\">18:04</td>\n" +
            "<td class=\"sepline nowrap top\">\n" +
            "<span class=\"rtOnTime\" title=\"+0 min.\">p&#252;nktl.</span>\n" +
            "</td>\n" +
            "<td class=\"bold top nowrap sepline\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/traininfo.exe/dn/683157/252516/526090/35326/80?L=public&backLink=sq&date=15.10.17&time=18:04&sqPf=7:1111101&sqMj=5&sqDa=15.10.17&sqTi=17:06&station_evaId=15537&sqType=dep&station_type=dep&sqEvaId=15537&\"><img src=\"/hafas-res/img/sbs_pic.gif\" width=\"24\" height=\"24\" alt=\"S      1\" style=\"vertical-align:top\"> S      1</a>\n" +
            "</td>\n" +
            "<td class=\"sepline top\">\n" +
            "<span class=\"bold\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=8000563&boardType=dep&time=now&selectDate=today&maxJourneys=5&productsFilter=7:1111101&start=yes\">\n" +
            ...
            "<tr>\n" +
            "<td class=\"links\">\n" +
            "<a href=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=18:04%2B1&productsFilter=7:1111101&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&maxJourneys=5&&start=yes&dirInput=&\"><b><img class=\"icon\" src=\"/hafas-res/img/icon_std.gif\" width=\"13\" height=\"13\" alt=\"\" /> Weitere Fahrten</b></a>\n" +
            "</td>\n" +
            "<td class=\"links\">\n" +
            ...
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=00:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">00:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=01:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">01:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=02:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">02:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=03:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">03:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=04:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">04:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=05:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">05:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=06:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">06:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=07:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">07:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=08:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">08:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=09:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">09:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=10:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">10:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=11:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">11:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=12:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">12:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=13:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">13:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=14:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">14:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=15:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">15:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=16:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">16:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=17:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">17:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=18:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">18:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=19:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">19:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=20:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">20:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=21:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">21:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=22:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">22:00</option>\n" +
            "<option value=\"http://www.saarfahrplan.de/cgi-bin/stboard.exe/dn?L=public&input=15537&boardType=dep&time=23:00&maxJourneys=5&dateBegin=15.10.17&dateEnd=15.10.17&selectDate=today&productsFilter=7:1111101&start=yes&dirInput=&\">23:00</option>\n" +
            "</select>\n" +
            "</td>\n" +
            "</tr>\n" +
            "</table>\n" +
            ...
            "<br />\n" +
            "Software/Daten: HAFAS 5.42.STANDARD.4.7/5.42.STANDARD.5.0.1 - 15.10.17\n" +
            "<br />\n" +
            "&#169; 2017\n" +
