...
public class Display4Activity extends DisplayActivity implements GestureDetector.OnGestureListener {

    public final static int INIT_STATION_ID = 10205;
    public final static String DISPLAY_NUMBER = "D4";
    private Button refreshButton;
    private Button vorwaertsButton;
    private Button rueckwaertsButton;
    private GestureDetectorCompat mDetector = null;

    public Display4Activity() {
        super(INIT_STATION_ID, DISPLAY_NUMBER, 3);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if(!isPortraitOrientation())removeRows(R.id.tableLayoutSDSBD4);
        loadSettings();
    ...
    public boolean isAlleChecked() {
        final RadioButton radioButtonAlle = (RadioButton) findViewById(R.id.radioButtonAlleD4);
        return radioButtonAlle.isChecked();
    }


    public void onRadioButtonClickedD4(View view) {
        resetTimer();
    ...
    private void initRefreshButton() {
        refreshButton = (Button) findViewById(R.id.refreshButtonD4);
    ...
    private void initVorwaertsButton() {
        vorwaertsButton = (Button) findViewById(R.id.buttonNextD4);
        vorwaertsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Display4Activity.this, MainActivity.class));
            }
        });
    }
    */
    ...
    private void initRueckwaertsButton() {
        rueckwaertsButton = (Button) findViewById(R.id.buttonBackD4);
        rueckwaertsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Display4Activity.this, Display3Activity.class));
